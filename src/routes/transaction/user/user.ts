...
import { addFolder, identifyUserType } from "../../../middleware/auth.js";
...
router.get(
  "/:storeId/person/@self",
  [addFolder, identifyUserType],
  User.getUserHandler
);
router.get(
  "/:storeId/person/b2b/@self",
  [addFolder, identifyUserType],
  User.getUserHandler
);

// /store/{storeId}/person/{userId}
router.get("/:storeId/person/:userId", identifyUserType, async (req, res) => {
...
router.put("/:storeId/person/@self", async (req, res) => {
...
router.post("/:storeId/person", async (req, res) => {
