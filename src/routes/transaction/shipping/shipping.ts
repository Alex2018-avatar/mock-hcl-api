...
import { ShippingController } from "../../../controllers/shipping/Shipping.js";
...
shippingRouter.put("/:storeId/cart/@self/shipping_infoz", async (req, res) => {
...
shippingRouter.post(
  "/:storeId/shipping/payment",
  ShippingController.addShippingPayment
);
