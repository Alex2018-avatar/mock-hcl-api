...
import { identifyUserType } from "../../../middleware/auth";
...
import {
  getEntitledOrgs,
  getOrganizationById,
} from "@controllers/organization/organization";
const app = express();
const router = app.router;

// /wcs/resources/store/11/organization/@self/entitled_orgs?langId=-1
router.get(
  "/:storeId/organization/@self/entitled_orgs",
  addFolder,
  getEntitledOrgs
);

// router.get(
//   "/:storeId/usercontext/@self/contextdata",
//   addFolder,
//   identifyUserType,
//   (req, res) => {
...
//           entitlement: {
//             eligibleTradingAgreementIds: [4000000000000000003],
//             hostingContractId: 4000000000000000002,
//             currentTradingAgreementIds: [4000000000000000003],
...
//           resourceName: "usercontext",
//           entitlement: {
//             eligibleTradingAgreementIds: [4e18],
//             hostingContractId: 4e18,
//             currentTradingAgreementIds: [4e18],
//             activeOrganizationId: -2000,
//             sessionTradingAgreementIds: null,
//           },
//           isPartiallyAuthenticated: false,
...
router.get("/:storeId/organization/:id", addFolder, getOrganizationById);
