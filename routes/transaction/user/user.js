...
userRouter.get('/:storeId/person/@self', async (req, res) => {
  ...
  res.status(200).json({
    ...
    "resourceId": "https:\/\/commerce-preview.sbx0127.play.hclsofy.com:5443\/wcs\/resources\/store\/11\/person\/@self?langId=-1",
    "preferredCurrency": "USD",
    "distinguishedName": "uid=demo@gmail.com,o=default organization,o=root organization",
    "orgizationId": "-2000",
