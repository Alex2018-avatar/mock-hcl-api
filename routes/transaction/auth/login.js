...
authRouter.post('/:storeId/loginidentity', async (req, res) => {
  const { storeId, emsName } = req.params;

  res.cookie('JSESSIONID', '0000i-MPMsY_DPOHukKSy6mkSj-:-1', {
    httpOnly: true, // Opcional: solo accesible a través de HTTP, no en JavaScript
    //secure: process.env.NODE_ENV === 'production', 
    maxAge: 3600000, // Opcional: tiempo en milisegundos
  });
